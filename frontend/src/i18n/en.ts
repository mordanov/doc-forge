const en = {
  ...
  step3: {
    ...
    hints: {
      ...
      outputFormats: 'Choose the output format for the final document.',
      ...
      coverPage: 'Cover page style. Auto picks based on template; Photo uses a full-bleed image; Minimal shows just the title; Illustration uses a decorative graphic; None skips the cover page.',
      tableOfContents: 'How to handle the table of contents. Generate creates a new one; Update Existing refreshes an existing TOC; Keep Existing leaves it untouched.',
      headersFooters: 'How to handle headers and footers. Generate creates new ones with title and page number; Replace Existing overwrites current; Keep Existing leaves them untouched.',
      ...
      imageSources: 'Image provider to search. Wikimedia is free; Pexels and Unsplash require API keys.',
