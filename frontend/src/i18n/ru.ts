...
const ru: Translations = {
  ...
  step3: {
    ...
    hints: {
      ...
      coverPage: 'Включить титульную страницу. Simple — только заголовок; Full — с автором и датой.',
      tableOfContents: 'Включить содержание. Standard — список глав; Detailed — включает подзаголовки.',
      headersFooters: 'Верхний и нижний колонтитулы. Standard — название документа в хедере, номер страницы в футере.',
